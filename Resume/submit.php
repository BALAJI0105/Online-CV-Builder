...
<head>
  ...
  <title><?php echo ucwords($first_name).($last_name).' Resume'; ?></title>
</head>
<body>
...
<div class="grid-container">
  ...
  <div class="zone-2">
    <div class="headTitle">
      <h3><?php echo ucwords($first_name);?>&nbsp;<b><?php echo ucwords($last_name);?></b></h3>
    </div>
    <div class="subTitle">
      <h3><?php echo ucwords($profession);?><h3>
    </div>
    <div class="group-1">
      <div class="title">
        <div class="box">
          <h2><em>Professional Summary</em></h2>
        </div>
      </div>
